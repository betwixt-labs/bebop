...
/// hash("{}{}")
pub const _SPING_SIGNATURE: u32 = 0x6be092d0;
...
pub const _SSUBMIT_ASIGNATURE: u32 = 0x14714c68;
...
pub const _SSUBMIT_BSIGNATURE: u32 = 0xd910de3b;
...
pub const _SSUBMIT_ABSIGNATURE: u32 = 0x17097b7b;
...
pub const _SSUBMIT_CSIGNATURE: u32 = 0xa774abdb;
...
/// hash("{{int32,int16,date,guid}}{}")
pub const _SRESPOND_ASIGNATURE: u32 = 0x1146a2c5;
...
/// hash("{{1:int32,2:int16,3:date,4:guid,5:string}}{}")
pub const _SRESPOND_BSIGNATURE: u32 = 0x8a8d5853;
...
pub const _SRESPOND_CSIGNATURE: u32 = 0x0c4d9793;
...
/// hash("{string}{}")
pub const _SSERVICE_NAME_SIGNATURE: u32 = 0x543bbba2;

#[cfg(any(feature = "bebop-owned-all", feature = "owned-generation-owned"))]
pub mod owned {
    #![allow(warnings)]
    ...
    pub use super::_SPING_SIGNATURE;

    pub use super::SSubmitAReturn;

    pub use super::SSubmitAArgs;

    pub use super::_SSUBMIT_ASIGNATURE;
    ...
    pub use super::_SSUBMIT_BSIGNATURE;
    ...
    pub use super::_SSUBMIT_ABSIGNATURE;
    ...
    pub use super::_SSUBMIT_CSIGNATURE;

    pub use super::SRespondAReturn;

    pub use super::SRespondAArgs;

    pub use super::_SRESPOND_ASIGNATURE;
    ...
    pub use super::_SRESPOND_BSIGNATURE;
    ...
    pub use super::_SRESPOND_CSIGNATURE;
    ...
    pub use super::_SSERVICE_NAME_SIGNATURE;
    ...
    pub trait SHandlersDef: ::core::marker::Send + ::core::marker::Sync {
        ...
        fn submit_ab<'f>(&self, _handle: ::bebop::rpc::TypedRequestHandle<'f, super::SSubmitABReturn>, a: ObjA, b: ObjB, c: bool, d: ::std::string::String) -> ::bebop::rpc::DynFuture<'f, ()>;
    ...
    impl<_Def: SHandlersDef> ::bebop::rpc::ServiceHandlers for SHandlers<_Def> {
        ...
        fn _recv_call<'f>(&self, datagram: &::bebop::rpc::Datagram, handle: ::bebop::rpc::RequestHandle) -> ::bebop::rpc::DynFuture<'f, ()> {
            ...
            if let ::bebop::rpc::Datagram::RpcRequestDatagram { header: req_header, opcode, data } = datagram {
                ...
                match opcode {
                    0 => {
                        if req_header.signature != _SSERVICE_NAME_SIGNATURE {
                            return ::bebop::dyn_fut! { ::bebop::handle_respond_error!(handle.send_invalid_sig_response(_SSERVICE_NAME_SIGNATURE), "S", "service_name", call_id); }
                        }
                        self.service_name(handle.into())
                    }
                    4096 => {
                        if req_header.signature != _SPING_SIGNATURE {
                            return ::bebop::dyn_fut! { ::bebop::handle_respond_error!(handle.send_invalid_sig_response(_SPING_SIGNATURE), "S", "ping", call_id); }
                        }
                        self.ping(handle.into())
                    }
                    8192 => {
                        if req_header.signature != _SSUBMIT_ASIGNATURE {
                            return ::bebop::dyn_fut! { ::bebop::handle_respond_error!(handle.send_invalid_sig_response(_SSUBMIT_ASIGNATURE), "S", "submit_a", call_id); }
                        }
                    ...
                    8193 => {
                        if req_header.signature != _SSUBMIT_BSIGNATURE {
                            return ::bebop::dyn_fut! { ::bebop::handle_respond_error!(handle.send_invalid_sig_response(_SSUBMIT_BSIGNATURE), "S", "submit_b", call_id); }
                        }
                    ...
                    8194 => {
                        if req_header.signature != _SSUBMIT_ABSIGNATURE {
                            return ::bebop::dyn_fut! { ::bebop::handle_respond_error!(handle.send_invalid_sig_response(_SSUBMIT_ABSIGNATURE), "S", "submit_ab", call_id); }
                        }
                        let args = match SSubmitABArgs::deserialize(data) {
                            Ok(args) => args,
                            Err(err) => return ::bebop::dyn_fut! { ::bebop::handle_respond_error!(handle.send_decode_error_response(Some(&err.to_string())), "S", "submit_ab", call_id) }
                        };
                        self.submit_ab(handle.into(), args.a, args.b, args.c, args.d)
                    }
                    8195 => {
                        if req_header.signature != _SSUBMIT_CSIGNATURE {
                            return ::bebop::dyn_fut! { ::bebop::handle_respond_error!(handle.send_invalid_sig_response(_SSUBMIT_CSIGNATURE), "S", "submit_c", call_id); }
                        }
                    ...
                    12289 => {
                        if req_header.signature != _SRESPOND_ASIGNATURE {
                            return ::bebop::dyn_fut! { ::bebop::handle_respond_error!(handle.send_invalid_sig_response(_SRESPOND_ASIGNATURE), "S", "respond_a", call_id); }
                        }
                        self.respond_a(handle.into())
                    }
                    12290 => {
                        if req_header.signature != _SRESPOND_BSIGNATURE {
                            return ::bebop::dyn_fut! { ::bebop::handle_respond_error!(handle.send_invalid_sig_response(_SRESPOND_BSIGNATURE), "S", "respond_b", call_id); }
                        }
                        self.respond_b(handle.into())
                    }
                    16387 => {
                        if req_header.signature != _SRESPOND_CSIGNATURE {
                            return ::bebop::dyn_fut! { ::bebop::handle_respond_error!(handle.send_invalid_sig_response(_SRESPOND_CSIGNATURE), "S", "respond_c", call_id); }
                        }
    ...
    impl SRequests {
        ...
        #[inline]
        pub async fn submit_ab(&self, timeout: ::core::option::Option<::core::time::Duration>, a: super::ObjA, b: super::ObjB<'_>, c: bool, d: &'_ str) -> ::bebop::rpc::RemoteRpcResponse<()> {
            self.submit_ab_raw(timeout, &super::SSubmitABArgs { a, b, c, d })?
            .await?; Ok(())
        }

        pub fn submit_ab_raw<'data>(&self, timeout: ::core::option::Option<::core::time::Duration>, payload: &'data super::SSubmitABArgs) -> ::bebop::rpc::TransportResult<impl 'data + Sized + ::core::future::Future<Output = ::bebop::rpc::RemoteRpcResponse<SSubmitABReturn>>> {
            let zelf = self.0.upgrade().ok_or(::bebop::rpc::TransportError::NotConnected)?;
            let fut = zelf.request::<_, SSubmitABReturn> (
                8194,
                timeout,
                _SSUBMIT_ABSIGNATURE,
                payload,
            );
            Ok(fut)
        }
