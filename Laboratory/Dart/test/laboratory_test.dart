...
void main() {
  group('Tests', () {
    ...
    test('Library', () {
      ...
      expect(decoded.songs['4f40c472-2eca-4375-b9c6-f8aa87684579'].performers, hasLength(2));
      expect(decoded.songs['4f40c472-2eca-4375-b9c6-f8aa87684579'].performers[1].name, equals('Miles Davis'));
    });
  });
}
